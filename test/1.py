...
tbmcp = [
    {
      "type": "function",
      "function": {
        "name": "generate_area_chart/mcp-server-chart",
    ...
    },
    {
      "type": "function",
      "function": {
        "name": "generate_bar_chart/mcp-server-chart",
    ...
    },
    {
      "type": "function",
      "function": {
        "name": "generate_column_chart/mcp-server-chart",
    ...
    },
    {
      "type": "function",
      "function": {
        "name": "generate_dual_axes_chart/mcp-server-chart",
    ...
    },
    {
      "type": "function",
      "function": {
        "name": "generate_fishbone_diagram/mcp-server-chart",
    ...
    },
    {
      "type": "function",
      "function": {
        "name": "generate_flow_diagram/mcp-server-chart",
    ...
    },
    {
      "type": "function",
      "function": {
        "name": "generate_histogram_chart/mcp-server-chart",
    ...
    },
    {
      "type": "function",
      "function": {
        "name": "generate_line_chart/mcp-server-chart",
    ...
    },
    {
      "type": "function",
      "function": {
        "name": "generate_mind_map/mcp-server-chart",
    ...
    },
    {
      "type": "function",
      "function": {
        "name": "generate_network_graph/mcp-server-chart",
    ...
    },
    {
      "type": "function",
      "function": {
        "name": "generate_pie_chart/mcp-server-chart",
    ...
    },
    {
      "type": "function",
      "function": {
        "name": "generate_radar_chart/mcp-server-chart",
    ...
    },
    {
      "type": "function",
      "function": {
        "name": "generate_scatter_chart/mcp-server-chart",
    ...
    },
    {
      "type": "function",
      "function": {
        "name": "generate_treemap_chart/mcp-server-chart",
    ...
    },
    {
      "type": "function",
      "function": {
        "name": "generate_word_cloud_chart/mcp-server-chart",
...
print([t.get('function').get('name').split('/')[0] for t in tbmcp])

v = [
    {
      "type": "function",
      "function": {
        "name": "get_data/xiyan-mcp-server",
    ...
    },
{
      "type": "function",
      "function": {
        "name": "get_current_time/zytime",
        "description": "用于获取当前时间和日期",
        "parameters": {
          "properties": {},
          "type": "object"
        }
...
my_dict = {'name': {'age': 25}}
keys_list = list(my_dict.keys())[0]  # 转换为列表

...
agent = [
  {'field': 'name', 'text': '智能体名称', 'default': '', 'placeholder': '给您的智能体取名', 'type': 'input', 'required': 'f', 'update': 't'},
  {'field': 'remarks', 'text': '描述介绍', 'default': '', 'placeholder': '介绍下您的智能体', 'type': 'text', 'required': 'f', 'update': 't'},
  {'field': 'agentid', 'text': '智能体id', 'default': 'in', 'placeholder': '智能体id', 'type': 'select', 'required': 't', 'update': 't',  'options': [{'label': '内部', 'value': 'in'}, {'label': '外部', 'value': 'out'}]},
  ...
  {'field': 'appid', 'text': '公司id', 'default': '', 'placeholder': '公司id', 'type': 'input', 'required': 'f', 'update': 't'},
  {'field': 'state', 'text': '状态', 'default': '', 'placeholder': '重排序模型', 'type': 'input', 'required': 'f', 'update': 't'},
  {'field': 'time', 'text': '更新时间', 'default': '', 'placeholder': '向量数据库', 'type': 'input', 'required': 'f', 'update': 't'},
...
{'field': 'img_show', 'text': '文件上传', 'default': 't', 'placeholder': '开户后自动显示url图片', 'type': 'select', 'required': 'f', 'update': 't', 'options': [{'label': '开启', 'value': 't'}, {'label': '关闭', 'value': 'f'}]},
     {'field': 'rag', 'text': 'rag知识库', 'default': '', 'placeholder': '知识库列表，多选', 'type': 'select',
      'required': 'f', 'update': 't', 'options': [{'label': '开启', 'value': 't'}, {'label': '关闭', 'value': 'f'}]},
     {'field': 'file', 'text': '文件知识库', 'default': '', 'placeholder': '文件列表，多选', 'type': 'select',
      'required': 'f', 'update': 't', 'options': [{'label': '开启', 'value': 't'}, {'label': '关闭', 'value': 'f'}]},
